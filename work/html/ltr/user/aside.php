    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" nav-item"><a href="jobcart.php"><i class="ft-user"></i><span class="menu-title" data-i18n="">Job Cart</span></a>
          </li>
            ...
            <ul class="menu-content">
              ...
              <li><a class="menu-item" href="#">Vertical</a>
                <ul class="menu-content">
                  ...
                  <li><a class="menu-item" href="index.html">Modern Menu</a>
                  </li>
                  <li><a class="menu-item" href="../vertical-menu-template/index.html">Semi Light</a>
                  </li>
                  <li><a class="menu-item" href="../vertical-menu-template-semi-dark/index.html">Semi Dark</a>
                  </li>
                  <li><a class="menu-item" href="../vertical-menu-template-nav-dark/index.html">Nav Dark</a>
                  </li>
                  <li><a class="menu-item" href="../vertical-menu-template-light/index.html">Light</a>
                  </li>
                  <li><a class="menu-item" href="../vertical-overlay-menu-template/index.html">Overlay Menu</a>
                  </li>
                </ul>
              </li>
              <li><a class="menu-item" href="#">Horizontal</a>
                <ul class="menu-content">
                  <li><a class="menu-item" href="../horizontal-menu-template/index.html">Classic</a>
                  </li>
                  <li><a class="menu-item" href="../horizontal-menu-template-nav/index.html">Nav Dark</a>
                  </li>
                </ul>
              </li>
            </ul>
              ...
              <li><a class="menu-item" href="#">Vertical Nav</a>
                <ul class="menu-content">
                  <li><a class="menu-item" href="#">Navigation Types</a>
                    <ul class="menu-content">
                      <li><a class="menu-item" href="../vertical-menu-template/index.html">Vertical Menu</a>
                      </li>
                      <li><a class="menu-item" href="../vertical-overlay-menu-template/index.html">Vertical Overlay</a>
                      </li>
                    </ul>
                  </li>
          ...
          <li class=" nav-item"><a href="changelog.html"><i class="ft-file"></i><span class="menu-title" data-i18n="">Changelog</span><span class="badge badge badge-pill badge-info float-right">3.1</span></a>
          </li>
