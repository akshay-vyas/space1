            ...
            <div class="card">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="active">
                                ...
                                <a class="nav-link active"  id="home-tab" data-toggle="tab" href="#create" role="tab" aria-controls="home" aria-selected="true">Add Vendor</a>
                ...
                <div class="card-content tab-pane" id="create">
                    <div class="card-body">
                        <div class="row">
                 ...
                 <div class="card-content tab-pane active" id="contact">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                <fieldset class="form-group">
