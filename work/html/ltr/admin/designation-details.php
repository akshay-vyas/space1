...
// Adding / Insrting Designation Names
...
if(isset($_POST['add_designation']))
{
  ...
  $add_designation=mysqli_query($conn,"insert into designation_details values(null,'$designation_name','$designation_status')");
}
        ...
        <div class="card-content collapse show">
          <div class="card-body card-dashboard">
              ...
              <div class="form-body">
                ...
                <input type="text" class="form-control" placeholder="Designation Name" name="designation_name" aria-describedby="button-addon2">
                <div class="input-group-append" id="button-addon2">
                  <button class="btn btn-primary" type="submit" id="userinput2" class="btn btn-primary" name="add_designation" value="submit"><i class="fa fa-check-square-o"></i>  Add</button>
                </div>
              </div>
  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
       ...
       <!-- Fetching / Displaying Designations -->
            ...
            <table class="table table-striped table-bordered dataex-html5-export">
              ...
              <tbody>
                ...
                $sql=mysqli_query($conn,"select * from designation_details");
                foreach ($sql as $doc) 
                {
                ...
                <tr>
                  <td><?php echo $i;?></td>
                  <td><?php echo $doc['designation_name']; ?></td>
                  <td>Edit</td>
                  <td>Delete</td>
